...
### Tentackl — Workflow Orchestration Engine
**Domain**: `flow.fluxtopus.com` | **UI**: `fluxtopus.com`

Tentackl is the brain of the platform. It enables users to describe goals in natural language and have autonomous agents plan and execute them. Key capabilities:

- **Autonomous Task Execution**: Users describe *what* they need, not how. Tentackl plans the steps, selects the right agents, and executes them independently.
...
- **Workflow Integration**: Tentackl tasks trigger notifications through Mimic automatically.
